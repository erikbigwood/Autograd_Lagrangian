...
Constructing successful NN Lagrangians, like constructing any other machine learning model, becomes an exercise in balancing expressivity and computational constraints. Certain functions are much less representable via this method than others, as I will explore later in this report.
